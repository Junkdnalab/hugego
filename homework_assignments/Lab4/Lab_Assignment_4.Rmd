...
Execute an over-representation analysis (ORA) using Gene Ontology. Set fold change to 0.5 and try out all three categories and choose one of the results to include an image and discussion below.

![](<your-image-here>)

<span style="color:#31a354"><i><b>
What is your interpretation of the result? Include a discussion of the parameters you chose.
</b></i></span>
